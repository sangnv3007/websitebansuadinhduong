								...
								<div class="menu-list">
									<ul class="container-all-name-list">
										<li class="menu has-child">
											<a class="a has-category" href="chitiet.php?id=1" title="DANH MỤC SỮA BỘT">											
													<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
													<span>DANH MỤC SỮA BỘT</span>											
													<i class="fas fa-caret-right"></i>
											</a>									
											<!-- <ul class="level1 menu-child">
												<li><a href="chitiet.php" title="Sữa Nutifood">Sữa Nutifood</a></li>
										...
										<li class="menu has-child">
											<a class="a has-category" href="chitiet.php?id=2" title="SỮA ĐẶC TRỊ NGƯỜI BỆNH">											
													<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
										...
										<li class="menu dont-has-child">
											<a class="a has-category" href="chitiet.php?id=3" title="THỰC PHẨM CHỨC NĂNG">											
													<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
													<span>THỰC PHẨM CHỨC NĂNG</span>																						
											</a>
										</li><!--End danh mục tpcn-->
										<li class="menu has-child">
											<a class="a has-category" href="chitiet.php?id=4" title="SỮA NON">											
													<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
													<span>SỮA NON</span>											
													<i class="fas fa-caret-right"></i>
											</a>									
										...
										<li class="menu dont-has-child">
											<a class="a has-category" href="chitiet.php?id=5" title="SỮA NHẬP KHẨU">											
													<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
													<span>SỮA NHẬP KHẨU</span>											
											</a>
										</li><!--End danh mục sữa nhập khẩu-->
										<li class="menu dont-has-child">
											<a class="a has-category" href="chitiet.php?id=6" title="SỮA BỘT PHA SẴN">											
													<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
													<span>SỮA BỘT PHA SẴN</span>																							
											</a>
										</li><!--End danh mục sữa pha sẵn-->
										<li class="menu dont-has-child">
											<a class="a has-category" href="chitiet.php?id=7" title="SỮA TĂNG CÂN CHO BÉ">											
													<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
						...
						<div class="vertical-menu-content">
							<div class="menu-list">
								<ul class="container-all-name-list">
									...
									<li class="menu dont-has-child">
										<a class="a has-category" href="chitiet.php?id=5" title="SỮA BỘT PHA SẴN">											
												<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
												<span>SỮA BỘT PHA SẴN</span>																							
										</a>
									</li><!--End danh mục sữa pha sẵn-->
									<li class="menu dont-has-child">
										<a class="a has-category" href="chitiet.php?id=6" title="SỮA TĂNG CÂN CHO BÉ">											
												<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
												<span>SỮA TĂNG CÂN CHO BÉ</span>																						
										</a>
									</li><!--End danh mục sữa tăng cân cho bé-->
									<li class="menu dont-has-child">
										<a class="a has-category" href="chitiet.php?id=7" title="SỮA DINH DƯỠNG ENERIGHT">											
												<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
												<span>SỮA DINH DƯỠNG ENERIGHT</span>																						
										</a>
									</li><!--End danh mục sữa dinh dưỡng eneright-->
									<li class="menu dont-has-child">
										<a class="a has-category" href="chitiet.php?id=8" title="ĐỒ ĂN DẶM CHO BÉ">											
												<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
												<span>ĐỒ ĂN DẶM CHO BÉ</span>																						
										</a>
									</li><!--End danh mục đồ ăn dặm cho bé-->
									<li class="menu has-child">
										<a class="a has-category" href="chitiet.php?id=9" title="CÁC SẢN PHẨM BỈM">											
												<img class="icon-menu" alt="Danh mục sữa bột" src="images/icon.jpg "/>
												<span>CÁC SẢN PHẨM BỈM</span>											
												<i class="fas fa-caret-right"></i>
										</a>									
